...
import { getSinglePet } from "@/lib/action";
                        ...
                        <div className="flex flex-col mt-8">
                            ...
                            <div className="py-6">
                                ...
                                <p className="mt-3 leading-7 text-neutral-600">
                                    {pet.description ||
                                        `${pet.name} is a wonderful ${pet.species || "pet"} looking for a loving forever home. This adorable companion is ready to become a special part of your family.`}
                                </p>
